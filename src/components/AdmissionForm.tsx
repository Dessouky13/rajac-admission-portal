        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 ${align}`}>
          ...
          <div>
            ...
            <Select value={form.religion} onValueChange={(value) => handleSelectChange("religion", value)}>
              <SelectTrigger>
                <SelectValue placeholder={t("form.student.religionPh")} />
              </SelectTrigger>
              <SelectContent>
      ...
      <div>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-4 ${align}`}>
          ...
          <div>
            ...
            <Select value={form.fatherWork} onValueChange={(value) => handleSelectChange("fatherWork", value)}>
              <SelectTrigger>
                <SelectValue placeholder={t("form.father.workPh")} />
              </SelectTrigger>
              <SelectContent>
